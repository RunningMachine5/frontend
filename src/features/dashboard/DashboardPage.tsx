  ...
  return <article className="panel suspicious-panel">
    <div className="panel-head">
      ...
      <div className="suspicious-panel-meta">
        ...
        <span className="trend-badge">선택 기간 기준</span>
      </div>
    </div>
...
export function DashboardPage() {
  ...
  return <AppLayout activeNav="dashboard">
    <div className="dashboard-content" id="main">
      <header className="app-page-header dashboard-header"><PageHeading eyebrow="FRAUD MONITORING" title="이상거래 감시" /><div className="header-actions"><LiveStatus label="SSE 실시간 연결됨" /></div></header>
